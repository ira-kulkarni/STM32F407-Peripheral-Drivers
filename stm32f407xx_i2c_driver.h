...
typedef struct
{
	...
	uint8_t 		TxRxState;		// To sture communication state
	uint8_t 		DevAddr;		// To store slave/device address
	uint8_t 		RxSize;			// To store Rx size
	uint8_t 		Sr;				// To sure repeated start value
}I2C_Handle_t;
...
#define I2C_SCL_SPEED_FM4K 	400000 // 4 kiloHertz
#define I2C_SCL_SPEED_F2K 	200000 // 2 kiloHertz
 ...
 */
void I2C_InterruptIRQConfig(uint8_t IRQNumber, uint8_t IRQPriority, uint8_t EnorDi);
...
void I2C_SSOE_Config(I2C_RegDef_t *pI2Cx, uint8_t EnOrDi);
